(function (global, factory) {
  ...
  moment$2 = moment$2 && Object.prototype.hasOwnProperty.call(moment$2, 'default') ? moment$2['default'] : moment$2;
  ...
  class Event {
    ...
    defaultRenderImplementation() {
      return /*#__PURE__*/React.createElement('div', {}, this.attributes.content || this.attributes.range.start.format('MMM DD YYYY'));
    }
  ...
  class EventsCollection {
    ...
    prepareEventAttributes(eventAttrs, eventDay) {
      ...
      return _objectSpread2(_objectSpread2({}, attrs), range);
    }
  ...
  class Event$1 extends React.Component {
    ...
    render() {
      ...
      var children = this.props.duration.isEditing() ? /*#__PURE__*/React.createElement(Edit, {
  ...
  class Day extends React.Component {
    ...
    renderEvents() {
      ...
      this.props.layout.forDay(this.props.day).forEach(duration => {
        var event = /*#__PURE__*/React.createElement(Event$1, {
          duration: duration,
          key: duration.key(),
          day: this.props.day,
          parent: this,
      ...
      if (allDayEvents.length || !asMonth) {
        events.push( /*#__PURE__*/React.createElement("div", _extends({
          key: "allday"
  ...
  class XLabels extends React.Component {
    ...
    render() {
      return /*#__PURE__*/React.createElement("div", {
        className: "x-labels"
      }, this.days.map(day => /*#__PURE__*/React.createElement("div", {
  ...
  class YLabels extends React.Component {
    ...
    renderLabels() {
      ...
      return this.hours.map(hour => /*#__PURE__*/React.createElement("div", {
        key: hour,
        className: "hour"
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
        className: "y-labels"
      }, /*#__PURE__*/React.createElement("div", this.props.layout.propsForAllDayEventContainer(), "All Day"), this.renderLabels()));
    }
  ...
  class Dayz extends React.Component {
    ...
    renderDays() {
      return this.days.map((day, index) => /*#__PURE__*/React.createElement(Day, {
        key: day.format('YYYYMMDD'),
        day: day,
        position: index,
        layout: this.layout,
